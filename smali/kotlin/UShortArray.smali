...
.method public static containsAll-impl([SLjava/util/Collection;)Z
    ...
    .line 62
    .local v6, "$i$a$-all-UShortArray$containsAll$1":I
    instance-of v7, v5, Lkotlin/UShort;
    ...
    check-cast v7, Lkotlin/UShort;

    invoke-virtual {v7}, Lkotlin/UShort;->unbox-impl()S

    move-result v7

    invoke-static {p0, v7}, Lkotlin/collections/ArraysKt;->contains([SS)Z
    ...
    .end local v6    # "$i$a$-all-UShortArray$containsAll$1":I
    :goto_0
    if-nez v5, :cond_1
...
.method public static equals-impl([SLjava/lang/Object;)Z
    ...
    check-cast v0, Lkotlin/UShortArray;

    invoke-virtual {v0}, Lkotlin/UShortArray;->unbox-impl()[S
