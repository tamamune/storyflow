...
.method private static final parseDuration(Ljava/lang/String;Z)J
    ...
    invoke-static {v2, v3, v11, v1, v0}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .local v5, "$this$substringWhile$iv":Ljava/lang/String;
    const/4 v11, 0x0

    .line 1497
    .local v11, "$i$f$substringWhile":I
    move-object/from16 v16, v5
    ...
    .end local v11    # "$i$f$substringWhile":I
    ...
    .local v11, "$this$skipWhile$iv$iv":Ljava/lang/String;
    ...
    .end local v11    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    ...
    .local v20, "infinityString":Ljava/lang/String;
    .local v25, "hasSign":Z
    invoke-direct {v11, v10, v14}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v11, v15}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    .local v18, "nonDigitSymbols":Ljava/lang/String;
    invoke-static {v11, v15, v2, v10, v14}, Lkotlin/text/StringsKt;->contains$default(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .end local v18    # "nonDigitSymbols":Ljava/lang/String;
    ...
    .end local v2    # "nonDigitSymbols":Ljava/lang/String;
    .restart local v18    # "nonDigitSymbols":Ljava/lang/String;
    :goto_6
    const/4 v2, 0x1
    ...
    .line 1371
    .end local v5    # "$this$substringWhile$iv":Ljava/lang/String;
    ...
    .line 1376
    invoke-static {v5, v3}, Lkotlin/time/DurationUnitKt;->durationUnitByIsoChar(CZ)Lkotlin/time/DurationUnit;
    ...
    .local v12, "prevUnit":Lkotlin/time/DurationUnit;
    if-eqz v12, :cond_d
    ...
    invoke-virtual {v12, v15}, Lkotlin/time/DurationUnit;->compareTo(Ljava/lang/Enum;)I
    ...
    .line 1379
    .end local v12    # "prevUnit":Lkotlin/time/DurationUnit;
    ...
    invoke-static {v14, v15, v11}, Lkotlin/time/DurationKt;->toDuration(DLkotlin/time/DurationUnit;)J
    ...
    .end local v15    # "isNegative":Z
    .end local v19    # "prevUnit":Lkotlin/time/DurationUnit;
    .restart local v12    # "prevUnit":Lkotlin/time/DurationUnit;
    .restart local v18    # "nonDigitSymbols":Ljava/lang/String;
    .restart local v20    # "infinityString":Ljava/lang/String;
    .restart local v23    # "isNegative":Z
    .restart local v25    # "hasSign":Z
    ...
    .line 1408
    .local v18, "$i$a$-substringWhile-DurationKt$parseDuration$component$2":I
    move/from16 v19, v2

    .end local v2    # "allowSpaces":Z
    .local v19, "allowSpaces":Z
    ...
    .local v17, "$this$skipWhile$iv$iv":Ljava/lang/String;
    .local v21, "$i$f$substringWhile":I
    invoke-direct {v2, v5, v4}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v2, v1}, Lkotlin/ranges/CharRange;->contains(C)Z
    ...
    .line 1510
    .end local v1    # "it":C
    .end local v18    # "$i$a$-substringWhile-DurationKt$parseDuration$component$2":I
    :goto_11
    if-eqz v2, :cond_1f
    ...
    .end local v17    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .end local v19    # "allowSpaces":Z
    .end local v21    # "$i$f$substringWhile":I
    .restart local v2    # "allowSpaces":Z
    .restart local v4    # "$i$f$substringWhile":I
    .restart local v5    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    :cond_1e
    move/from16 v19, v2
    ...
    .end local v4    # "$i$f$substringWhile":I
    .end local v5    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v17    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v19    # "allowSpaces":Z
    .restart local v21    # "$i$f$substringWhile":I
    :cond_1f
    nop
    ...
    .line 1411
    .local v18, "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    move/from16 v21, v3
    ...
    .local v22, "$this$skipWhile$iv$iv":Ljava/lang/String;
    const/16 v10, 0x7a

    invoke-direct {v3, v6, v10}, Lkotlin/ranges/CharRange;-><init>(CC)V

    invoke-virtual {v3, v5}, Lkotlin/ranges/CharRange;->contains(C)Z

    move-result v3

    .line 1516
    .end local v5    # "it":C
    .end local v18    # "$i$a$-substringWhile-DurationKt$parseDuration$unitName$1":I
    if-eqz v3, :cond_22
    ...
    .end local v21    # "$i$f$substringWhile":I
    .end local v22    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v3    # "$i$f$substringWhile":I
    .restart local v10    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    :cond_21
    move/from16 v21, v3
    ...
    .end local v10    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    .restart local v21    # "$i$f$substringWhile":I
    .restart local v22    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    :cond_22
    nop

    .line 1512
    .end local v4    # "i$iv$iv":I
    .end local v15    # "$i$f$skipWhile":I
    .end local v22    # "$this$skipWhile$iv$iv":Ljava/lang/String;
    ...
    .line 1419
    .local v6, "whole":Ljava/lang/String;
    move-object v10, v14
    ...
    .line 1423
    .end local v6    # "whole":Ljava/lang/String;
    :cond_26
    move-object v10, v14
...
.method private static final parseOverLongIsoComponent(Ljava/lang/String;)J
    ...
    invoke-virtual {v12, v13}, Lkotlin/ranges/CharRange;->contains(C)Z
