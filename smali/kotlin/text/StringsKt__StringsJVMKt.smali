...
.method public static final capitalize(Ljava/lang/String;Ljava/util/Locale;)Ljava/lang/String;
    ...
    .local v4, "$this$capitalize_u24lambda_u245":Ljava/lang/StringBuilder;
    const/4 v5, 0x0
    ...
    .line 753
    .end local v4    # "$this$capitalize_u24lambda_u245":Ljava/lang/StringBuilder;
...
.method public static final contentEquals(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    .locals 1
    .param p0, "$this$contentEquals"    # Ljava/lang/CharSequence;
...
.method private static final lowercase(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .param p0, "$this$lowercase"    # Ljava/lang/String;
...
.method public static final replace(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    .local v0, "$this$replace_u24lambda_u241":Ljava/lang/StringBuilder;
    const/4 v2, 0x0

    .line 73
    .local v2, "$i$a$-buildString-StringsKt__StringsJVMKt$replace$1":I
    move-object v3, p0
    ...
    .line 74
    .local v8, "$i$a$-forEach-StringsKt__StringsJVMKt$replace$1$1":I
    invoke-static {v7, p1, p3}, Lkotlin/text/CharsKt;->equals(CCZ)Z
    ...
    .line 830
    .end local v7    # "c":C
    .end local v8    # "$i$a$-forEach-StringsKt__StringsJVMKt$replace$1$1":I
    nop
    ...
    .line 72
    .end local v0    # "$this$replace_u24lambda_u241":Ljava/lang/StringBuilder;
    .end local v2    # "$i$a$-buildString-StringsKt__StringsJVMKt$replace$1":I
    invoke-virtual {v1}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
...
.method public static final replace(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3, p3}, Lkotlin/text/StringsKt;->indexOf(Ljava/lang/CharSequence;Ljava/lang/String;IZ)I
    ...
    invoke-virtual {v6, v8, v7, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;
    ...
    invoke-static {v8, p1, v9, p3}, Lkotlin/text/StringsKt;->indexOf(Ljava/lang/CharSequence;Ljava/lang/String;IZ)I
    ...
    invoke-virtual {v6, v8, v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;
...
.method static synthetic toCharArray$default(Ljava/lang/String;[CIIIILjava/lang/Object;)[C
    .locals 0
    .param p0, "$this$toCharArray_u24default"    # Ljava/lang/String;
    .param p1, "destination"    # [C
    .param p2, "destinationOffset"    # I
    .param p3, "startIndex"    # I
    .param p4, "endIndex"    # I
...
.method static synthetic toPattern$default(Ljava/lang/String;IILjava/lang/Object;)Ljava/util/regex/Pattern;
    .locals 0
    .param p0, "$this$toPattern_u24default"    # Ljava/lang/String;
    .param p1, "flags"    # I
...
.method private static final uppercase(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .param p0, "$this$uppercase"    # Ljava/lang/String;
